...
{   
  ...
  21:	7e 1e                	jle    41 <main+0x41>
  23:	8d 4c b3 fc          	lea    -0x4(%ebx,%esi,4),%ecx
  ...
  3d:	8d 44 b3 fc          	lea    -0x4(%ebx,%esi,4),%eax
    }
    argv[i] = '\0';
  41:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
	int pid;
	int a = 0, b = 0;	
  47:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
  4e:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
	pid = fork();
  55:	e8 b1 02 00 00       	call   30b <fork>
	if (pid == 0)
  5a:	85 c0                	test   %eax,%eax
  5c:	75 36                	jne    94 <main+0x94>
  	{	
  		exec(argv[0], argv);
  5e:	52                   	push   %edx
  5f:	52                   	push   %edx
  60:	53                   	push   %ebx
  61:	ff 33                	pushl  (%ebx)
  63:	e8 e3 02 00 00       	call   34b <exec>
    	printf(1, "exec %s failed\n", argv[1]);
  68:	83 c4 0c             	add    $0xc,%esp
  6b:	ff 73 04             	pushl  0x4(%ebx)
  6e:	68 e8 07 00 00       	push   $0x7e8
  73:	6a 01                	push   $0x1
  ...
  7d:	ff 75 e4             	pushl  -0x1c(%ebp)
  80:	ff 75 e0             	pushl  -0x20(%ebp)
  83:	68 f8 07 00 00       	push   $0x7f8
  88:	6a 01                	push   $0x1
  ...
  94:	50                   	push   %eax
  95:	50                   	push   %eax
  96:	8d 45 e4             	lea    -0x1c(%ebp),%eax
  99:	50                   	push   %eax
  9a:	8d 45 e0             	lea    -0x20(%ebp),%eax
  9d:	50                   	push   %eax
  9e:	e8 10 03 00 00       	call   3b3 <waitx>
  a3:	83 c4 10             	add    $0x10,%esp
  a6:	eb d5                	jmp    7d <main+0x7d>
  a8:	66 90                	xchg   %ax,%ax
  aa:	66 90                	xchg   %ax,%ax
  ac:	66 90                	xchg   %ax,%ax
  ae:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	eb 1a                	jmp    620 <printf+0x1a0>
          s = "(null)";
 606:	bb 14 08 00 00       	mov    $0x814,%ebx
        while(*s != 0){
