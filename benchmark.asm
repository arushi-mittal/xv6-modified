...
int main(int argc, char *argv[])
{
  ...
  16:	a1 f8 0a 00 00       	mov    0xaf8,%eax
  1b:	85 c0                	test   %eax,%eax
  1d:	7e 3c                	jle    5b <main+0x5b>
  1f:	31 db                	xor    %ebx,%ebx
  21:	eb 12                	jmp    35 <main+0x35>
  ...
  2d:	39 1d f8 0a 00 00    	cmp    %ebx,0xaf8
  33:	7e 26                	jle    5b <main+0x5b>
    int pid = fork();
  35:	e8 21 03 00 00       	call   35b <fork>
    if (pid < 0)
  ...
  41:	83 c3 01             	add    $0x1,%ebx
      printf(1, "Fork failed\n");
  44:	68 38 08 00 00       	push   $0x838
  49:	6a 01                	push   $0x1
  4b:	e8 80 04 00 00       	call   4d0 <printf>
      continue;
  50:	83 c4 10             	add    $0x10,%esp
  for (j = 0; j < number_of_processes; j++)
  53:	39 1d f8 0a 00 00    	cmp    %ebx,0xaf8
  ...
  5b:	83 3d f8 0a 00 00 fc 	cmpl   $0xfffffffc,0xaf8
  ...
  bc:	3b 05 f8 0a 00 00    	cmp    0xaf8,%eax
  c2:	7d c0                	jge    84 <main+0x84>
        if (k <= j)
 ...
 42c:	89 d1                	mov    %edx,%ecx
{
 ...
 459:	0f b6 92 4c 08 00 00 	movzbl 0x84c(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	eb 1a                	jmp    670 <printf+0x1a0>
          s = "(null)";
 656:	bb 45 08 00 00       	mov    $0x845,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a5:	a1 fc 0a 00 00       	mov    0xafc,%eax
{
 ...
 6c6:	73 10                	jae    6d8 <free+0x38>
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	a3 fc 0a 00 00       	mov    %eax,0xafc
}
 6f7:	5e                   	pop    %esi
 6f8:	5f                   	pop    %edi
 6f9:	5d                   	pop    %ebp
 ...
 717:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 71a:	a3 fc 0a 00 00       	mov    %eax,0xafc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 73d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 740:	8b 3d fc 0a 00 00    	mov    0xafc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 789:	8b 3d fc 0a 00 00    	mov    0xafc,%edi
 ...
 7b2:	e8 e9 fe ff ff       	call   6a0 <free>
  return freep;
 7b7:	a1 fc 0a 00 00       	mov    0xafc,%eax
 ...
 7e4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7e7:	a3 fc 0a 00 00       	mov    %eax,0xafc
}
 ...
 7fe:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 fc 0a 00 00 00 	movl   $0xb00,0xafc
 807:	0b 00 00 
    base.s.size = 0;
 80a:	bf 00 0b 00 00       	mov    $0xb00,%edi
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 00 0b 00 00 00 	movl   $0xb00,0xb00
 816:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 81b:	c7 05 04 0b 00 00 00 	movl   $0x0,0xb04
 822:	00 00 00 
    if(p->s.size >= nunits){
