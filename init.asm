...
main(void)
{
  ...
  43:	58                   	pop    %eax
  44:	5a                   	pop    %edx
  45:	68 40 08 00 00       	push   $0x840
  4a:	6a 01                	push   $0x1
  4c:	e8 7f 04 00 00       	call   4d0 <printf>
  ...
  b4:	50                   	push   %eax
  b5:	50                   	push   %eax
  b6:	68 54 0b 00 00       	push   $0xb54
  bb:	68 7e 08 00 00       	push   $0x87e
  c0:	e8 d6 02 00 00       	call   39b <exec>
      printf(1, "init: exec sh failed\n");
  c5:	5a                   	pop    %edx
  c6:	59                   	pop    %ecx
  c7:	68 81 08 00 00       	push   $0x881
  cc:	6a 01                	push   $0x1
