  ...
  17:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  28:	e8 23 04 00 00       	call   450 <printf>
    exit();
  2d:	e8 b1 02 00 00       	call   2e3 <exit>
  }
  priority = atoi(argv[1]);
  32:	83 ec 0c             	sub    $0xc,%esp
  35:	ff 76 04             	pushl  0x4(%esi)
  38:	e8 33 02 00 00       	call   270 <atoi>
  3d:	89 c3                	mov    %eax,%ebx
  pid = atoi(argv[2]);
  3f:	58                   	pop    %eax
  40:	ff 76 08             	pushl  0x8(%esi)
  43:	e8 28 02 00 00       	call   270 <atoi>
  if (priority < 0 || priority > 100){
  48:	83 c4 10             	add    $0x10,%esp
  4b:	83 fb 64             	cmp    $0x64,%ebx
  4e:	76 13                	jbe    63 <main+0x63>
    printf(2,"Invalid priority\n");
  50:	51                   	push   %ecx
  51:	51                   	push   %ecx
  52:	68 d4 07 00 00       	push   $0x7d4
  57:	6a 02                	push   $0x2
  59:	e8 f2 03 00 00       	call   450 <printf>
    exit();
  5e:	e8 80 02 00 00       	call   2e3 <exit>
  }
  ...
  65:	50                   	push   %eax
  66:	53                   	push   %ebx
  67:	e8 27 03 00 00       	call   393 <set_priority>
  exit();
 ...
 3ac:	89 d1                	mov    %edx,%ecx
{
 ...
 3d9:	0f b6 92 f0 07 00 00 	movzbl 0x7f0(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	eb 1a                	jmp    5f0 <printf+0x1a0>
          s = "(null)";
 5d6:	bb e6 07 00 00       	mov    $0x7e6,%ebx
        while(*s != 0){
